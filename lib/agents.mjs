...
ANALYSIS: Summarise experience level, goal, event date, availability, recent frequency, longest run, duration, pace, fatigue, constraints, and data quality. Compare current information with the goal without guaranteeing success. If pain, chest symptoms, fainting, severe breathlessness, or another serious warning is reported, set SAFETY_REVIEW_REQUIRED.
